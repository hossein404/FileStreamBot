...
-   **پنل مدیریت وب امن و پایدار**: کاربران را مدیریت کرده و آمار ربات را از طریق یک پنل وب ساده و امن مشاهده کنید. این پنل دارای رمزنگاری برای رمز عبور، حفاظت در برابر حملات CSRF و جلسات ورود پایدار (حتی پس از ری‌استارت) به کمک Redis است.
