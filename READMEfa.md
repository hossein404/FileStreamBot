...
-   **پنل مدیریت وب**: مدیریت کاربران و مشاهده آمار از طریق یک پنل وب ساده.
...
-   **ورود**: برای ورود از `ADMIN_USERNAME` و `ADMIN_PASSWORD` که در فایل `.env` تنظیم کرده‌اید، استفاده کنید.
